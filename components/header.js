...
// import Logo from "../yimages/Logo.png";
const createHeader = async () => {
    ...
    return `
                <div id="mupper">
                    <div id="mgrid">
                        <div><i class="fa-solid fa-phone"></i> &nbsp;88255 28630</div>
                        <div> 
                            <select name="" id="">
                ...
                <div id="mmiddle">
                    <div style={{width:"60px",height:"60px"}} id="mlogo">
                          <img id="mlogoimg" src="../yimages/Logo.png">
                    </div>
