...
let bbSmallIcon = "../yimages/Logo.png";
let bbLargeIcon = "../yimages/Logo.png";
...
window.addEventListener("scroll", () => {
    ...
    if(window.innerWidth >= 700){
        if(window.scrollY > 0){
            ...
            bbLogoIcon.style.width = "100px";
            bbLogoIcon.style.height = "100px";
        ...
        if(window.scrollY === 0){
            ...
            bbLogoIcon.style.width = "90px";
            bbLogoIcon.style.height = "90px";
            // middleNav.style.marinTop = "-30px"; 
